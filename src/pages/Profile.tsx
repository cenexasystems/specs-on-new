...
const STATUS_COLORS: Record<string, { bg: string; text: string; label: string }> = {
  ...
  completed: { bg: '#D8D0C5', text: '#1A1410', label: 'Completed' },
...
export default function Profile() {
  ...
  const handleSaveProfile = async () => {
    ...
    if (trimPhone && !isValidPhone(trimPhone)) { setSaveErr('Enter a valid Indian mobile number (e.g. 9876543210 or +91 12-345 6789).'); return }
    if (!user) return
