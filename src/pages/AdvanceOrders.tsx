...
const STATUS_STYLES: Record<AdvanceStatus, string> = {
  ...
  waiting_final_payment: 'bg-warm-beige\/30 text-choc-brown border-violet-200', completed: 'bg-warm-beige\/30 text-choc-brown border-emerald-200', cancelled: 'bg-red-50 text-red-700 border-red-200',
}
...
export default function AdvanceOrders({ onOrderCompleted }: AdvanceOrdersProps = {}) {
  ...
  return <div className="space-y-5">
    ...
    {notice && <div className="rounded-xl border border-emerald-200 bg-warm-beige\/30 px-4 py-3 text-sm font-semibold text-choc-brown">{notice}</div>}
